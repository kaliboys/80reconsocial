...
printf "                                                                          \e[1;92m  \e[0m\n"
printf "                                                                      \e[1;92m          \e[0m\n"
printf "\e[1;77m  | | ____| _| (_) |__   ___  _   _ ___   ___ ___  _ __ ___   \e[0m\e[1;92m _        _  \e[0m\n"
printf "\e[1;77m  | |/ / _| | | | |_ \ / _ \| | | / __| / __/ _ \|  _   _ \ \e[0m\e[1;92m// \ IR   / \\ \e[0m\n"
printf "\e[1;77m  |   < (_| | | | |_) | (_) | |_| \__ \| (_| (_) | | | | | |\e[0m\e[1;92m|\__\    /__/  \e[0m\n"
printf "\e[1;77m  |_|\_\__,_|_|_|_.__/ \___/ \__, |___(_)___\___/|_| |_| |_|\e[0m\e[1;92m\    ||    / \e[0m\n"
printf "\e[1;77m                            |___/                            \e[0m\e[1;92m\        / \e[0m\n"
printf "                               \e[1;92mv1.0,  www.kaliboys.com     \e[0m   \e[1;92m\  __  / \e[0m\n"
printf "                                                                          \e[1;92m   \e[0m\n"
...
check_cloob=$(curl -s -H "Accept-Language: en" "https://www.cloob.com/name/$username" -L | grep -o 'notFound clearfix'; echo $?)
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Cloob: \e[0m"

if [[ $check_cloob == *'1'* ]]; then
printf "\e[1;92m Found!\e[0m https://www.cloob.com/name/%s\n" $username
printf "https://www.cloob.com/name/%s\n" $username > $username.txt
elif [[ $check_cloob == *'0'* ]]; then
...
check_facenama=$(curl -s -H "Accept-Language: en" "https://www.facenama.com/$username" -L | grep -o '404 Error'; echo $?)
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Facenama: \e[0m"

if [[ $check_facenama == *'1'* ]]; then
printf "\e[1;92m Found!\e[0m https://www.Facenama.com/%s\n" $username
printf "https://www.facenama.com/%s\n" $username > $username.txt
elif [[ $check_facenama == *'0'* ]]; then
printf "\e[1;93mNot Found!\e[0m\n"
fi
...
check_hamkhone=$(curl -s -H "Accept-Language: en" "https://www.hamkhone.ir/$username" -L | grep -o 'نشد'; echo $?)
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Hamkhone: \e[0m"
